...
%%%% I agree with your comment, but I think we need to distinguish
%%%% between things like actual and apparent survival probs.
%\hl{[Feels a little repetitious with the material
...
%Possibly it's better this way, though.]}
...
i.e. the recruitment rate. In cases where no movement occurs, the DM model can directly estimate

...
\noindent
\begin{enumerate}
\item Models of population dynamics play a central role in theoretical and
...
process of interest.
\item Conventional state-space models, however, have
...
\item We expand this class of models to accommodate classical growth
...
\item A simulation study indicated that bias was negligible and coverage
...
However, Bayesian inference has several appealing features. First, it
...
models estimated very low survival probabilities %for ovenbird 
($\omega$ =

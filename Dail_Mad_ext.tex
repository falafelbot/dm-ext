...
\author{Jeffrey A. Hostetler\\ %\footnote{Contact:
...
%        \small Migratory Bird Center \\
   ...
   \and Richard B. Chandler \footnote{Contact:
     \url{RChandler@usgs.gov}, +001-301-497-5856} \\
...
users to specify the model using a simple symbolic descriptions. 
...
\citep{robbins_etal:1986,sauer_etal:1994auk,diefenbach_etal:2003,campbell_francis:2011}.%,alldredge_etal:2007auk
...
effects and, where appropriate, environmental stochasticity or zero-inflated dynamics.  We used

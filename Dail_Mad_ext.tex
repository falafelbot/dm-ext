...
\usepackage{fancyvrb}
\usepackage{verbatim}
\usepackage[colorlinks=true,citecolor=black,linkcolor=black,urlcolor=black,pdftex,pdfstartview=FitH,bookmarks=true]{hyperref}
...
hypotheses regarding spatial and temporal variation in abundance, for
example to test for the existence of density-dependence population
growth \citep{dennis_taper:1994,viljugrein_etal:2005}. Such models are
...
Several complicating factors must be confronted when
...
detection. Failure to account for process variation and observation

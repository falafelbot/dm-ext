...
dynamics of the geometric-recruitment, exponential, Ricker-logistic, or Gompertz-logistic
models
...
first place. Because population size at any future point %Furthermore, b
...
variation in regional population growth rate, Eq.~\ref{eq:nuRand}) and, where appropriate, zero-inflated dynamics.  We used
...
we obtained these estimates from a single chain.  We present these estimates for ovenbirds only.
...
more than halved.
% (from 0.026 $\pm$ 0.006 to 0.011 $\pm$ 0.005 [for
...
For both species, constant-recruitment dynamics models estimated very high
survival probabilities ($\omega$ = 1 $\pm$ 1.3e-05 for ovenbird and
0.935 $\pm$ 0.011 for
golden-winged warbler). The geometric-recruitment and geometric-recruitment + immigration

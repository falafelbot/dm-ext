...
\usepackage[pdftex,hidelinks,pdfstartview={XYZ 1 1 1.5},bookmarks=true]{hyperref}
\usepackage{rotating}
...
that false negative observation errors are equally likely as false positive

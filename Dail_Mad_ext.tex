...
($\zeta$). Temporal variation in $N_t$ is modeled using a
deterministic population growth model (e.g. exponential, logistic, etc
\dots) and stochastic model allowing for random process variation. A
simple state

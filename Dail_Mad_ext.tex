...
to achieve unbiasedness, and doing so is possible using recently
...
populaiton size under future environmental conditions. Implementation
...
A simulation study was used to assess bias and accurrancy of parameter
estimators, and an analysis of %We demonstrate these developments by analyzing
%data from the
North American Breeding Bird Survey is presented for illustration.
}
...
% indicates that no process variation is
...
effects requires removing the random effects

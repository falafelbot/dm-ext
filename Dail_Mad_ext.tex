...
sets are characterized by missing data and observation error, which
...
Recently, state-space models have been developed to deal with these problems
...
population dynamics, and (3) they assert an implausible model for
...
\item Results of a simulation study suggest that bias is %was 
...
\citep{dennis_etal:2006}, which are not available otherwise. % which is much more computationally efficient

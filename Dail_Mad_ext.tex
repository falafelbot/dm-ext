...
bias. Therefore, ecologists have increasingly relied on state-space
...
population dynamics, and (3) we have no clear interpretation of the
...
methods. We provide code to fit these models using the \textbf{R} package
...
can be readily applied to existing data, but it also suggested 
that precision would be low when we lack direct information about detection
...
more than halved (Table S3.2 OR Figure S3.1, Appendix 3). %to 0.011 $\pm$ 0.005 [for
